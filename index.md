...
Development of a parallelized search algorithm for _Small Integral Trees_, connected acyclic graphs whose adjacency matrix has only integral eigenvalues. [PDF](/assets/small_integral_trees.pdf){:target="_blank"}, [some examples](https://www.win.tue.nl/~aeb/graphs/integral_trees.html)){:target="_blank"}
